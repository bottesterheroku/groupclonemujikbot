    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📲 Updates", url=f"https://t.me/DynamicCourses"), 
                    InlineKeyboardButton(
                        "💬 Support", url=f"https://t.me/DynamicCourses")
                ],[
                    InlineKeyboardButton(
                        "🛠 Source Code 🛠", url=f"https://github.com/bottesterheroku/groupclonemujikbot")
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Support Chat", url=f"https://t.me/DynamicCourses}"
                    )
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 Updates', url=f"https://t.me/DynamicCourses"),
             InlineKeyboardButton(text = '💬 Support', url=f"https://t.me/DynamicCourses")],
            [InlineKeyboardButton(text = '🛠 Source Code 🛠', url=f"https://github.com/bottesterheroku/groupclonemujikbot")],
